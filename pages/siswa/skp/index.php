    ...
    <div class="card-body">
        ...
        <div class="tab-content mt-3">
            <div class="tab-pane fade show active" id="data" role="tabpanel" aria-labelledby="data-tab">
                <?php
                    // Get current user data from siswa table
                    $query_current_user = mysqli_query($kon, "SELECT * FROM siswa WHERE username='$username' LIMIT 1");
                        ...
                        <form id="formDataPegawai">
                            ...
                            <div class="border p-3 mb-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control bg-light" name="nama_pegawai" value="<?php echo isset($current_user['nama_siswa']) ? $current_user['nama_siswa'] : ''; ?>" readonly>
                                        <!-- <small class="text-muted">Data dari profil</small> -->
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control bg-light" name="nip_pegawai" value="<?php echo isset($current_user['nis']) ? $current_user['nis'] : ''; ?>" readonly>
                                        <!-- <small class="text-muted">Data dari profil (NIS)</small> -->
                                    </div>
                                </div>
                ...
                $(document).ready(function() {
                    $('#formDataPegawai').on('submit', function(e) {
                        ...
                        $.ajax({
                            url: 'pages/siswa/skp/save-data.php',
                            type: 'POST',
                            data: $(this).serialize(),
                            dataType: 'json',
            ...
            <div class="tab-pane fade" id="skp-jaif" role="tabpanel" aria-labelledby="skp-jaif-tab">
                <?php
                    // Get current user from siswa table
                    $username = $_SESSION['username'];
                    $query_user = mysqli_query($kon, "SELECT * FROM siswa WHERE username='".$username."' LIMIT 1");
                    $user_data = mysqli_fetch_array($query_user);
                    
                    // Get data pejabat penilai
                    $query_pegawai_data = mysqli_query($kon, "SELECT * FROM skp_data_pegawai WHERE username='".$username."' LIMIT 1");
                    $pegawai_data = mysqli_fetch_array($query_pegawai_data);
                                    ...
                                    <td width="50%" class="p-0">
                                        <table class="table table-sm mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo isset($user_data['nama_siswa']) ? $user_data['nama_siswa'] : ''; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">2</td>
                                                <td>NIP</td>
                                                <td><?php echo isset($user_data['nis']) ? $user_data['nis'] : ''; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">3</td>
                                                <td>PANGKAT/GOL. RUANG</td>
                                                <td><?php echo isset($user_data['pangkat_gol']) ? $user_data['pangkat_gol'] : '-'; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">4</td>
                                                <td>JABATAN</td>
                                                <td><?php echo isset($user_data['jabatan']) ? $user_data['jabatan'] : '-'; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">5</td>
                                                <td>UNIT KERJA</td>
                                                <td><?php echo isset($user_data['unit_kerja']) ? $user_data['unit_kerja'] : '-'; ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td width="50%" class="p-0 border-left">
                                        <table class="table table-sm mb-0">
                                            ...
                                            <tr>
                                                <td class="text-center">1</td>
                                                <td width="150">NAMA</td>
                                                <td><?php echo isset($pegawai_data['nama_penilai']) ? $pegawai_data['nama_penilai'] : '-'; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">2</td>
                                                <td>NIP/NRP</td>
                                                <td><?php echo isset($pegawai_data['nip_penilai']) ? $pegawai_data['nip_penilai'] : '-'; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">3</td>
                                                <td>PANGKAT/GOL. RUANG</td>
                                                <td><?php echo isset($pegawai_data['pangkat_gol_penilai']) ? $pegawai_data['pangkat_gol_penilai'] : '-'; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">4</td>
                                                <td>JABATAN</td>
                                                <td><?php echo isset($pegawai_data['jabatan_penilai']) ? $pegawai_data['jabatan_penilai'] : '-'; ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">5</td>
                                                <td>UNIT KERJA</td>
                                                <td><?php echo isset($pegawai_data['unit_kerja_penilai']) ? $pegawai_data['unit_kerja_penilai'] : '-'; ?></td>
                                            </tr>
                                        </table>
                ...
                function editPejabatPenilai() {
                    $.get('pages/siswa/skp/get-pejabat-penilai.php', function(data) {
                ...
                function simpanPejabatPenilai() {
                    ...
                    $.ajax({
                        url: 'pages/siswa/skp/save-pejabat-penilai.php',
                        type: 'POST',
                ...
                function loadHasilKerja() {
                    $.get('pages/siswa/skp/get-hasil-kerja.php', function(data) {
                ...
                function loadPerilakuKerja() {
                    $.get('pages/siswa/skp/get-perilaku-kerja.php', function(data) {
                ...
                function simpanHasilKerja() {
                    ...
                    $.ajax({
                        url: 'pages/siswa/skp/save-hasil-kerja.php',
                        type: 'POST',
                        contentType: 'application/json',
                ...
                function simpanPerilakuKerja() {
                    $.ajax({
                        url: 'pages/siswa/skp/save-perilaku-kerja.php',
                        type: 'POST',
                        contentType: 'application/json',
            ...
            <div class="tab-pane fade" id="lampiran-skp" role="tabpanel" aria-labelledby="lampiran-skp-tab">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-6 text-center">
                                ...
                                <p class="font-weight-bold mb-0"><?php echo $user_data['nama_siswa']; ?></p>
                                <p>NIP/NRP <?php echo $user_data['nip']; ?></p>
                            </div>
                            <div class="col-md-6 text-center">
                ...
                function loadDukungan() {
                    $.get('pages/siswa/skp/get-dukungan.php', function(data) {
                ...
                function simpanDukungan() {
                    $.ajax({
                        url: 'pages/siswa/skp/save-dukungan.php',
                        type: 'POST',
                        contentType: 'application/json',
                ...
                function loadSkema() {
                    $.get('pages/siswa/skp/get-skema.php', function(data) {
                ...
                function simpanSkema() {
                    $.ajax({
                        url: 'pages/siswa/skp/save-skema.php',
                        type: 'POST',
                        contentType: 'application/json',
                ...
                function loadKonsekuensi() {
                    $.get('pages/siswa/skp/get-konsekuensi.php', function(data) {
                ...
                function simpanKonsekuensi() {
                    $.ajax({
                        url: 'pages/siswa/skp/save-konsekuensi.php',
                        type: 'POST',
                        contentType: 'application/json',
            ...
            <div class="tab-pane fade" id="cover" role="tabpanel" aria-labelledby="cover-tab">
                <?php
                    ...
                    $username = $_SESSION['username'];
                    $query = mysqli_query($kon, "SELECT * FROM siswa WHERE username='".$username."' LIMIT 1");
                    ...
                    // Set default values
                    $nama = $data_cover['nama'] ?? $data_guru['nama_siswa'];
                    $nip = $data_cover['nip'] ?? $data_guru['nis'];
                    $pangkat_gol = $data_cover['pangkat_gol'] ?? ($data_guru['pangkat_gol'] ?? '-');
                    $jabatan = $data_cover['jabatan'] ?? ($data_guru['jabatan'] ?? '-');
                    $unit_kerja = $data_cover['unit_kerja'] ?? ($data_guru['unit_kerja'] ?? '-');
                            ...
                            <form id="formCover" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>NIP</label>
                                            <input type="text" class="form-control" name="nip" id="edit_nip" value="<?php echo $nip; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="mt-5 pt-5">
                                        <table class="mx-auto" style="text-align: left; font-size: 14px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 8px;" id="display_nip"><?php echo $nip; ?></td>
                                            </tr>
                                            <tr>
                ...
                function saveCover() {
                    ...
                    var nip = document.getElementById('edit_nip').value;
                    ...
                    $.ajax({
                        url: 'pages/siswa/skp/save-cover.php',
                        type: 'POST',
                        data: {
                            nama: nama,
                            nip: nip,
                        ...
                        success: function(response) {
                            ...
                            document.getElementById('display_nip').innerText = nip;
            ...
            <div class="tab-pane fade" id="dok-evaluasi" role="tabpanel" aria-labelledby="dok-evaluasi-tab">
                <?php
                    // Ambil data guru yang sedang login
                    $username = $_SESSION['username'];
                    $query_pegawai = mysqli_query($kon, "SELECT * FROM siswa WHERE username='".$username."' LIMIT 1");
                    $data_pegawai = mysqli_fetch_array($query_pegawai);
                    
                    // Ambil data pejabat penilai dari skp_data_pegawai
                    $query_skp_pegawai = mysqli_query($kon, "SELECT * FROM skp_data_pegawai WHERE username='".$username."' LIMIT 1");
                    $skp_pegawai_data = mysqli_fetch_array($query_skp_pegawai);
                    ...
                    // Gunakan data dari skp_data_pegawai jika ada, kalau tidak ambil dari dok_evaluasi_kinerja
                    $pejabat_nama = $skp_pegawai_data['nama_penilai'] ?? ($data_dok['pejabat_nama'] ?? '');
                    $pejabat_nip = $skp_pegawai_data['nip_penilai'] ?? ($data_dok['pejabat_nip'] ?? '');
                    $pejabat_pangkat = $skp_pegawai_data['pangkat_gol_penilai'] ?? ($data_dok['pejabat_pangkat'] ?? '');
                    $pejabat_jabatan = $skp_pegawai_data['jabatan_penilai'] ?? ($data_dok['pejabat_jabatan'] ?? '');
                    $pejabat_unit = $skp_pegawai_data['unit_kerja_penilai'] ?? ($data_dok['pejabat_unit'] ?? '');
                    
                    $atasan_nama = $skp_pegawai_data['nama_atasan'] ?? ($data_dok['atasan_nama'] ?? '');
                    $atasan_nip = $skp_pegawai_data['nip_atasan'] ?? ($data_dok['atasan_nip'] ?? '');
                    $atasan_pangkat = $skp_pegawai_data['pangkat_gol_atasan'] ?? ($data_dok['atasan_pangkat'] ?? '');
                    $atasan_jabatan = $skp_pegawai_data['jabatan_atasan'] ?? ($data_dok['atasan_jabatan'] ?? '');
                    $atasan_unit = $skp_pegawai_data['unit_kerja_atasan'] ?? ($data_dok['atasan_unit'] ?? '');
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="pejabat_nip" value="<?php echo $pejabat_nip; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="atasan_nip" value="<?php echo $atasan_nip; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="dokumen-evaluasi" style="background: white; padding: 40px; border: 1px solid #ddd;">
                                ...
                                <table class="table table-bordered table-sm" style="font-size: 13px;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>: <?php echo $data_pegawai['nama_siswa']; ?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>NIP</td>
                                            <td>: <?php echo $data_pegawai['nis']; ?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>PANGKAT/GOL. RUANG</td>
                                            <td>: <?php echo isset($data_pegawai['pangkat_gol']) && $data_pegawai['pangkat_gol'] ? $data_pegawai['pangkat_gol'] : '-'; ?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>JABATAN</td>
                                            <td>: <?php echo isset($data_pegawai['jabatan']) && $data_pegawai['jabatan'] ? $data_pegawai['jabatan'] : 'Siswa'; ?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>UNIT KERJA</td>
                                            <td>: <?php echo isset($data_pegawai['unit_kerja']) && $data_pegawai['unit_kerja'] ? $data_pegawai['unit_kerja'] : '-'; ?></td>
                                        </tr>
                                        <tr class="bg-light">
                                            <td>2.</td>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>NIP/NRP</td>
                                            <td>: <span id="display_pejabat_nip"><?php echo $pejabat_nip; ?></span></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>PANGKAT/GOL. RUANG</td>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>NIP/NRP</td>
                                            <td>: <span id="display_atasan_nip"><?php echo $atasan_nip; ?></span></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>PANGKAT/GOL. RUANG</td>
                                ...
                                <div class="row mt-4" style="font-size: 12px;">
                                    <div class="col-4 text-center">
                                        <p class="mb-1">Jakarta, Desember 2025</p>
                                        <p class="mb-5">Pegawai yang Dinilai,</p>
                                        <p class="font-weight-bold mb-0" style="text-decoration: underline;"><?php echo $data_pegawai['nama_siswa']; ?></p>
                                        <p class="mb-0">NIP. <?php echo $data_pegawai['nip']; ?></p>
                                    </div>
                                    <div class="col-4 text-center">
                                        <p class="mb-1">Jakarta, Desember 2025</p>
                                        <p class="mb-5">Pejabat Penilai Kinerja,</p>
                ...
                function saveDokEvaluasi() {
                    var data = {
                        ...
                        pejabat_nip: document.getElementById('pejabat_nip').value,
                        ...
                        atasan_nip: document.getElementById('atasan_nip').value,
                    ...
                    $.ajax({
                        url: 'pages/siswa/skp/save-dok-evaluasi.php',
                        type: 'POST',
                        contentType: 'application/json',
                        ...
                        success: function(response) {
                            ...
                            document.getElementById('display_pejabat_nip').innerText = data.pejabat_nip;
                            ...
                            document.getElementById('display_atasan_nip').innerText = data.atasan_nip;
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <canvas id="chart1" style="height: 150px; width: 100%;"></canvas>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <canvas id="chart2" style="height: 150px; width: 100%;"></canvas>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <canvas id="chart3" style="height: 150px; width: 100%;"></canvas>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <canvas id="chart4" style="height: 150px; width: 100%;"></canvas>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <canvas id="chart5" style="height: 150px; width: 100%;"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
