        ...
        <div class="tab-content mt-3">
            <div class="tab-pane fade show active" id="data" role="tabpanel" aria-labelledby="data-tab">
                <div class="card">
                    <div class="card-body">
                        <h5>Data</h5>
                        <p>Konten untuk Data akan ditampilkan di sini.</p>
                        <!-- Tambahkan konten Data di sini -->
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="skp-jaif" role="tabpanel" aria-labelledby="skp-jaif-tab">
                ...
                function editPejabatPenilai() {
                    $.get('pages/guru/skp/get-pejabat-penilai.php', function(data) {
                ...
                function simpanPejabatPenilai() {
                    ...
                    $.ajax({
                        url: 'pages/guru/skp/save-pejabat-penilai.php',
                        type: 'POST',
                ...
                function loadHasilKerja() {
                    $.get('pages/guru/skp/get-hasil-kerja.php', function(data) {
                ...
                function loadPerilakuKerja() {
                    $.get('pages/guru/skp/get-perilaku-kerja.php', function(data) {
                ...
                function simpanHasilKerja() {
                    ...
                    $.ajax({
                        url: 'pages/guru/skp/save-hasil-kerja.php',
                        type: 'POST',
                        contentType: 'application/json',
                ...
                function simpanPerilakuKerja() {
                    $.ajax({
                        url: 'pages/guru/skp/save-perilaku-kerja.php',
                        type: 'POST',
                        contentType: 'application/json',
            ...
            <div class="tab-pane fade" id="lampiran-skp" role="tabpanel" aria-labelledby="lampiran-skp-tab">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-6 text-center">
                                ...
                                <p class="font-weight-bold mb-0"><?php echo $user_data['nama_guru']; ?></p>
                ...
                function loadDukungan() {
                    $.get('pages/guru/skp/get-dukungan.php', function(data) {
                ...
                function simpanDukungan() {
                    $.ajax({
                        url: 'pages/guru/skp/save-dukungan.php',
                        type: 'POST',
                        contentType: 'application/json',
                ...
                function loadSkema() {
                    $.get('pages/guru/skp/get-skema.php', function(data) {
                ...
                function simpanSkema() {
                    $.ajax({
                        url: 'pages/guru/skp/save-skema.php',
                        type: 'POST',
                        contentType: 'application/json',
                ...
                function loadKonsekuensi() {
                    $.get('pages/guru/skp/get-konsekuensi.php', function(data) {
                ...
                function simpanKonsekuensi() {
                    $.ajax({
                        url: 'pages/guru/skp/save-konsekuensi.php',
                        type: 'POST',
                        contentType: 'application/json',
            ...
            <div class="tab-pane fade" id="cover" role="tabpanel" aria-labelledby="cover-tab">
                <?php
                    ...
                    $username = $_SESSION['username'];
                    $query = mysqli_query($kon, "SELECT * FROM guru WHERE username='".$username."' LIMIT 1");
                    ...
                    // Set default values
                    $nama = $data_cover['nama'] ?? $data_guru['nama_guru'];
                    $nip = $data_cover['nip'] ?? $data_guru['nip'];
                ...
                function saveCover() {
                    ...
                    $.ajax({
                        url: 'pages/guru/skp/save-cover.php',
                        type: 'POST',
                        data: {
                            nama: nama,
                            nip: nip,
            ...
            <div class="tab-pane fade" id="dok-evaluasi" role="tabpanel" aria-labelledby="dok-evaluasi-tab">
                <?php
                    // Ambil data guru yang sedang login
                    $username = $_SESSION['username'];
                    $query_pegawai = mysqli_query($kon, "SELECT * FROM guru WHERE username='".$username."' LIMIT 1");
                    ...
                    $pejabat_nip = $data_dok['pejabat_nip'] ?? '';
                    ...
                    $atasan_nip = $data_dok['atasan_nip'] ?? '';
                            ...
                            <div class="dokumen-evaluasi" style="background: white; padding: 40px; border: 1px solid #ddd;">
                                ...
                                <table class="table table-bordered table-sm" style="font-size: 13px;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>: <?php echo $data_pegawai['nama_guru']; ?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>NIP</td>
                                ...
                                <div class="row mt-4" style="font-size: 12px;">
                                    <div class="col-4 text-center">
                                        <p class="mb-1">Jakarta, Desember 2025</p>
                                        <p class="mb-5">Pegawai yang Dinilai,</p>
                                        <p class="font-weight-bold mb-0" style="text-decoration: underline;"><?php echo $data_pegawai['nama_guru']; ?></p>
                ...
                function saveDokEvaluasi() {
                    ...
                    $.ajax({
                        url: 'pages/guru/skp/save-dok-evaluasi.php',
                        type: 'POST',
                        contentType: 'application/json',
