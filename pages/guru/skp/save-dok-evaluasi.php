...
$pejabat_nip = mysqli_real_escape_string($kon, $data['pejabat_nip'] ?? '');
...
$atasan_nip = mysqli_real_escape_string($kon, $data['atasan_nip'] ?? '');
...
$capaian_kinerja = mysqli_real_escape_string($kon, $data['capaian_kinerja'] ?? 'BAIK');
$predikat_kinerja = mysqli_real_escape_string($kon, $data['predikat_kinerja'] ?? 'BAIK');
...
$check = mysqli_query($kon, "SELECT * FROM dok_evaluasi_kinerja WHERE username='$username'");
